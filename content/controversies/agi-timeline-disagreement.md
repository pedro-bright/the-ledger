...
positions:
  - claim: "AGI is likely within the next 3-5 years (by ~2028-2030), and current scaling and reasoning approaches are sufficient to achieve it"
    ...
    sources:
      - url: https://darioamodei.com/machines-of-loving-grace
        title: "Machines of Loving Grace (Amodei, 2024)"
      - url: https://blog.samaltman.com/the-intelligence-age
        title: "The Intelligence Age (Altman, 2024)"
    confidence: low
  - claim: "AGI is 10-20+ years away and requires fundamental breakthroughs beyond current paradigms"
    ...
    confidence: medium
  - claim: "The concept of 'AGI' is ill-defined and the timeline debate is meaningless without a shared definition"
