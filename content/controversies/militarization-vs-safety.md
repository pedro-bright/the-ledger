...
positions:
  - claim: "Safety Through Engagement — AI labs should collaborate with militaries to shape responsible use from within"
    ...
    sources:
      - url: https://www.rand.org/pubs/research_reports/RRA2680-1.html
        title: "An Assessment of the U.S. and Chinese Industrial Bases in AI"
      - url: https://www.defense.gov/News/Releases/Release/Article/3578460/dod-announces-establishment-of-chief-digital-and-artificial-intelligence-office/
        title: "DoD Chief Digital and Artificial Intelligence Office"
    confidence: medium
  - claim: "Normalization of Militarization — Lab engagement legitimizes military AI and erodes ethical red lines"
    proponents: [civil-liberties-organizations, ai-researchers-against-military-ai, former-google-maven-protesters]
    sources:
      - url: https://www.icrac.net/
        title: "International Committee for Robot Arms Control"
      - url: https://futureoflife.org/open-letter/lethal-autonomous-weapons-pledge/
        title: "Lethal Autonomous Weapons Pledge"
    confidence: medium
  - claim: "Institutional Capture Risk — Military contracts create financial dependencies that corrupt safety-first missions"
    proponents: [governance-researchers, some-former-ai-lab-employees, institutional-accountability-advocates]
    sources:
      - url: https://www.technologyreview.com/2024/01/12/1086563/openai-military-ban-removed/
        title: "OpenAI quietly deletes ban on using ChatGPT for military and warfare"
    confidence: medium
  - claim: "Democratic Necessity — Democratic nations must develop military AI or cede advantage to authoritarian states"
    proponents: [defense-hawks, geopolitical-realists, some-bipartisan-legislators]
    sources:
      - url: https://www.nscai.gov/2021-final-report/
        title: "National Security Commission on AI Final Report"
    confidence: medium
  - claim: "Autonomous Weapons Red Line — A categorical distinction exists between military AI for logistics/intelligence and autonomous lethal weapons"
