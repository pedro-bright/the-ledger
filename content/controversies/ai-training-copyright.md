...
positions:
  - claim: "Training AI models on publicly available content is transformative fair use that benefits society"
    ...
    sources:
      ...
      - url: https://www.eff.org/deeplinks/2024/01/ai-fair-use-considerations
        title: "EFF on AI and Fair Use"
    confidence: medium
  - claim: "Using copyrighted works to train AI without permission or compensation is infringement at scale"
    ...
    sources:
      - url: https://nytco-assets.nytimes.com/2023/12/NYT_Complaint_Dec2023.pdf
        title: "NYT v. OpenAI Complaint"
      - url: https://authorsguild.org/news/ag-and-authors-file-class-action-suit-against-openai/
        title: "Authors Guild class action"
    confidence: medium
  - claim: "The copyright framework is inadequate — we need new legal structures (compulsory licensing, data dividends, collective bargaining) to address AI's impact on creators"
    proponents: [digital-rights-organizations, labor-advocates, some-legal-reformists]
    sources:
      - url: https://www.eff.org/issues/ai-copyright
        title: "EFF on AI and Copyright"
    confidence: medium
  - claim: "AI companies should negotiate voluntary licensing deals with willing rights holders, creating a market-based solution"
    proponents: [associated-press, axel-springer, some-media-companies-with-licensing-deals, pragmatic-industry-voices]
    sources:
      - url: https://www.ap.org/press-releases/2023/ap-openai-agreement
        title: "AP-OpenAI licensing agreement"
    confidence: medium
---
